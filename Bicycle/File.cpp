...
//------------------ IODevice -----------------------------------------------
ulong File::read(char *data, ulong size, ulong &errorCode)
{
  ulong length= 0;
...
//---------------------------------------------------------------------------
ulong File::write(const char *data, ulong size, ulong &errorCode)
{
  ulong length= 0;
...
//---------------------------------------------------------------------------
void File::checkErrorCode(ulong code)const
{
  if(code!=0)
